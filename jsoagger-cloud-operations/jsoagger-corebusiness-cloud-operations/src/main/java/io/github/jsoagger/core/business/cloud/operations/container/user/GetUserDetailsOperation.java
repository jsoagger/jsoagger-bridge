 ...
 *
 */
public class GetUserDetailsOperation implements IOperation {


  /**
   * Default Constructor
   */
  public GetUserDetailsOperation() {
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    try {
      ...
      IOperationResult result = CloudServicesLocator.userPrincipalApi.getUserDetails(query);
