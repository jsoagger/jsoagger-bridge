 ...
 *
 */
public class GetObjectCatalogByIdOperation implements IOperation {
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    ...
    try {
      ...
      IOperationResult result = CloudServicesLocator.objectCatalogApi.getObjectCatalogById(query);
