 ...
 * @date 3 févr. 2018
 */
public class GetTeamTemplateByNameOperation implements IOperation {


  /**
   * Constructor
   */
  public GetTeamTemplateByNameOperation() {
    super();
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    try {
      ...
      IOperationResult result = CloudServicesLocator.teamTemplateApi.getByName(query);
