 ...
 * @date 25 janv. 2018
 */
public class GetGroupMembersOperation implements IOperation {


  /**
   * Default Constructor
   */
  public GetGroupMembersOperation() {
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    try {
      ...
      IOperationResult result = CloudServicesLocator.userPrincipalApi.getGroupMembersOperation(query);
