 ...
 *
 */
public class GetAccountOfPartyOperation implements IOperation {


  /**
   * Default Constructor
   */
  public GetAccountOfPartyOperation() {
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    try {
      ...
      IOperationResult result = CloudServicesLocator.userPrincipalApi.accountOfParty(query);
