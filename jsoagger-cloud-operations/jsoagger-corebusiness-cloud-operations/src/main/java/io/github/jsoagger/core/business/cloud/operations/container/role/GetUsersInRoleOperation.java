 ...
 * @date 25 janv. 2018
 */
public class GetUsersInRoleOperation implements IOperation {

  /**
   * Default Constructor
   */
  public GetUsersInRoleOperation() {
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    try {
      ...
      IOperationResult result = CloudServicesLocator.userPrincipalApi.getUsersInRole(query);
