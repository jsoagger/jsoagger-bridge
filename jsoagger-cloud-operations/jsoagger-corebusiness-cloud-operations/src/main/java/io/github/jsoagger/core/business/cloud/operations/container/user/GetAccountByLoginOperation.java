 ...
 *
 */
public class GetAccountByLoginOperation implements IOperation {


  /**
   * Default Constructor
   */
  public GetAccountByLoginOperation() {
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    try {
      ...
      IOperationResult result = CloudServicesLocator.userPrincipalApi.getAccountByLogin(query);
