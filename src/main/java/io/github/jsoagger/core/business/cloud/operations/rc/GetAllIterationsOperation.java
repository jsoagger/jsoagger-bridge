 ...
 * @date 4 févr. 2018
 */
public class GetAllIterationsOperation implements IOperation {

  /**
   * Default Constructor
   */
  public GetAllIterationsOperation() {
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler,
    ...
    try {
      ...
      IOperationResult result = CloudServicesLocator.rcApi.allIterationsOf(query);
