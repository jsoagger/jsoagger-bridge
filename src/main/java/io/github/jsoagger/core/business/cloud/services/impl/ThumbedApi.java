...
public class ThumbedApi extends AbstractClientApi implements IThumbedApi {
  ...
  private static final String THUMB_URL = "/v1/secured/api/thumbed/%s/thumb/?w=%s&h=%s";
  private static final String illustration_URL = "/v1/secured/api/thumbed/%s/illustration/?w=%s&h=%s";
  private static final String format_URL = "/v1/secured/api/thumbed/%s/format";
