 ...
 *
 */
public class NotifyTeamOperation implements IOperation {

  public NotifyTeamOperation() {
    super();
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    try {
      ...
      IOperationResult result = CloudServicesLocator.notificationApi.notifyTeam(query);
