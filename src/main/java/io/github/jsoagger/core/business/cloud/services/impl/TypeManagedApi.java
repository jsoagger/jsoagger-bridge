...
public class TypeManagedApi extends AbstractClientApi implements ITypeManagedApi {
  ...
  private static final String attributeDefinitions_url = "/transdev/base/v1/secured/api/typeManaged/%s/attributeDefinitions/?containerId=%s";
  private static final String typeof_url = "/transdev/base/v1/secured/api/typeManaged/%s/typeOf/?containerId=%s";
