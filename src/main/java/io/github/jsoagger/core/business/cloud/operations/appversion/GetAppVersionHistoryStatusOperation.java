 ...
 * @date 2019 
 */
public class GetAppVersionHistoryStatusOperation implements IOperation {
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler,
    ...
    try {
      ...
      IOperationResult result = CloudServicesLocator.appVersionApi.getInstallationStatus(query);
