...
public class FolderApi extends AbstractClientApi implements IFolderApi {
  ...
  private static final String	FOLDER_CHILDREN_URI			= "/v1/secured/api/folder/%s/children/?containerId=%s";
  private static final String	COUNT_FOLDER_CHILDREN_URI	= "/v1/secured/api/folder/%s/children/count/?containerId=%s";
  private static final String	FOLDER_CONTENT_URI			= "/v1/secured/api/folder/%s/content/?contentClass=%s&page=%s&pageSize=%s&containerId=%s";
  private static final String	COUNT_FOLDER_CONTENT_URI	= "/v1/secured/api/folder/%s/content/count/?contentClass=%s&containerId=%s";
  private static final String	FOLDER_CREATE_URI			= "/v1/secured/api/folder/%s/?containerId=%s";
  private static final String   FOLDER_DELETE_URI           = "/v1/secured/api/folder/%s/?containerId=%s";
  private static final String   FOLDER_GET_URI           = "/v1/secured/api/folder/%s/?containerId=%s";
  private static final String	FOLDER_BY_PATH_URI			= "/v1/secured/api/folder/byPath?path=%s&containerId=%s";

  private static final String	POPULATE_FROM_URI	= "/v1/secured/api/folder/%s/populate/?templateId=%s&containerId=%s";
