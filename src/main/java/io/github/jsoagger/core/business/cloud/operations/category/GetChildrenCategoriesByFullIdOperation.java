 ...
 *
 */
public class GetChildrenCategoriesByFullIdOperation implements IOperation{
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler,
    ...
    try {
      ...
      IOperationResult result = CloudServicesLocator.categoryApi.getChildrenCategoriesByFullId(query);
