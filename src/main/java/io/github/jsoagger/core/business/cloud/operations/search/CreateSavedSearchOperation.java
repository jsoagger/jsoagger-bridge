 ...
 *
 */
public class CreateSavedSearchOperation implements IOperation {

  /**
   * Default Constructor
   */
  public CreateSavedSearchOperation() {
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    try {
      ...
      IOperationResult result = CloudServicesLocator.searchApi.createSavedSearch(query);
