 ...
 * @date 25 janv. 2018
 */
public class AddMembersInGroupOperation implements IOperation {

  /**
   * Default Constructor
   */
  public AddMembersInGroupOperation() {
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    try {
      ...
      IOperationResult result = CloudServicesLocator.userPrincipalApi.addMembersInGroupOperation(query);
