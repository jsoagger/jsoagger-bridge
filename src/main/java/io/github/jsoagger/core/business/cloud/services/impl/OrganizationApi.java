...
public class OrganizationApi extends AbstractClientApi implements IOrganizationApi {
  ...
  private static final String   BY_SIRET_EQUALS             = "/jsoagger/people/v1/secured/api/organization/bySiretEquals/?siret=%s&containerId=%s";
  private static final String   BY_NAME_LIKE                = "/jsoagger/people/v1/secured/api/organization/byNameLike/?name=%s&containerId=%s";
  private static final String   RENAME                      = "/jsoagger/people/v1/secured/api/organization/%s/rename/?containerId=%s";
