...
public class TeamTemplateApi extends AbstractClientApi implements ITeamTemplateApi {
  ...
  public static String	TEAM_TEMP_ROOT_URL	= "/jsoagger/base/v1/secured/api/teamTemplate/%s/?containerId=%s";
  public static String	BY_NAME_URL			= "/jsoagger/base/v1/secured/api/teamTemplate/byName?internalName=%s&containerId=%s";
  public static String	GET_BY_OID_URL		= "/jsoagger/base/v1/secured/api/teamTemplate/%s/?containerId=%s";
  public static String	GET_CLOB_URL		= "/jsoagger/base/v1/secured/api/teamTemplate/%s/template/?containerId=%s";
  public static String	MEMBERS_URL			= "/jsoagger/base/v1/secured/api/teamTemplate/%s/members/?containerId=%s";

  public static String	POPULATE_URL	= "/jsoagger/base/v1/secured/api/container/%s/populateMembers/?containerId=%s";
  public static String	GET_ALL_URL		= "/jsoagger/base/v1/secured/api/container/%s/teamTemplates/?&page=%s&pageSize=%s&sort=%s&containerId=%s";
