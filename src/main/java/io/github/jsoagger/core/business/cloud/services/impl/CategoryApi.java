...
public class CategoryApi extends AbstractClientApi implements ICategoryApi {
  ...
  private static final String ROOT_CATEGORIES_URL = "/jsoagger/classifiable/v1/secured/api/category/rootCategories?typeId=%s&ownerId=%s&containerId=%s";
  private static final String CATEGORY_BY_NUMBER_URL = "/jsoagger/classifiable/v1/secured/api/category/byNumber/?number=%s&containerId=%s";
  private static final String CATEGORY_BY_NAME_URL = "/jsoagger/classifiable/v1/secured/api/category/byName/?name=%s&typeId=%s&ownerId=%s&containerId=%s";
  private static final String CHILDREN_URL = "/jsoagger/classifiable/v1/secured/api/category/%s/children/?containerId=%s";
  private static final String PARENT_URL = "/jsoagger/classifiable/v1/secured/api/category/%s/parent/?containerId=%s";
  private static final String GET_URL = "/jsoagger/classifiable/v1/secured/api/category/%s/?containerId=%s";
