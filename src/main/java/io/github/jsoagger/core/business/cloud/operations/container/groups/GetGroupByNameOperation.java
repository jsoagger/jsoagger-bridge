 ...
 * @date 25 janv. 2018
 */
public class GetGroupByNameOperation implements IOperation {


  /**
   * Default Constructor
   */
  public GetGroupByNameOperation() {
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    try {
      ...
      IOperationResult result = CloudServicesLocator.userPrincipalApi.getGroupByName(query);
