 ...
 * @date 2019 
 */
public class GetAppPendingInstallationOperation implements IOperation {
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler,
    ...
    try {
      ...
      IOperationResult result = CloudServicesLocator.appVersionApi.getPendingInstallation(query);
