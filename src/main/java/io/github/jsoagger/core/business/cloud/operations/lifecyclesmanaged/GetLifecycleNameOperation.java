 ...
 * @date 4 févr. 2018
 */
public class GetLifecycleNameOperation implements IOperation {


  /**
   * Constructor
   */
  public GetLifecycleNameOperation() {
    super();
  }
  ...
  public void doOperation(JsonObject query,
    ...
    try {
      ...
      IOperationResult result = CloudServicesLocator.lifecycleManagedApi.getLifecycleName(query);
