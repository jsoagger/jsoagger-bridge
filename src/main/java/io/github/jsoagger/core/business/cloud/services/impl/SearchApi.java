...
public class SearchApi extends AbstractClientApi implements ISearchApi {
  ...
  private static final String	SEARCH_ENTITIES				= "/v1/secured/api/search/basic/entity/?containerId=%s";
  private static final String	GET_SAVED_SEARCHS_URL		= "/v1/secured/api/search/basic/savedSearchs?audience=%s&containerId=%s";
  private static final String	DELETE_SAVED_SEARCHS_URL	= "/v1/secured/api/search/basic/savedSearchs/%s/?containerId=%s";

  private static final String	SEARCH_RC_ENTITIES_ITERATIONS	= "/v1/secured/api/search/basic/rcEntitySearchIterations/?containerId=%s";
  private static final String	SEARCH_RC_ENTITIES_MASTERS		= "/v1/secured/api/search/basic/rcEntitySearchMasters/?containerId=%s";
