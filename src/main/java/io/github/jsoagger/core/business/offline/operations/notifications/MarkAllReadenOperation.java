 ...
 * @date 2019
 */
public class MarkAllReadenOperation implements IOperation {

  /**
   * Constructor
   */
  public MarkAllReadenOperation() {
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    try {
      IOperationResult result = OffLineServiceLocator.notificationsService.markAllNotificationsReaden(query);
