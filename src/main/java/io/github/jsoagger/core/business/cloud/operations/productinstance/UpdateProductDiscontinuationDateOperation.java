 ...
 *
 */
public class UpdateProductDiscontinuationDateOperation implements IOperation {
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    ...
    try {
      ...
      IOperationResult result = CloudServicesLocator.productInstanceApi.updateProductDiscontinuationDate(query);
