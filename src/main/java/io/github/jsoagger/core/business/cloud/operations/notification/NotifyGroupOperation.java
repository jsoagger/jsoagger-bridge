 ...
 *
 */
public class NotifyGroupOperation implements IOperation {

  public NotifyGroupOperation() {
    super();
  }
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler, Consumer<Throwable> exHandler) {
    try {
      ...
      IOperationResult result = CloudServicesLocator.notificationApi.notifyGroup(query);
