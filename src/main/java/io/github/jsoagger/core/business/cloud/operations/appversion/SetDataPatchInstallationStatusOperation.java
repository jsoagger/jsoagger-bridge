 ...
 *
 */
public class SetDataPatchInstallationStatusOperation implements IOperation {
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler,
    ...
    try {
      ...
      IOperationResult result = CloudServicesLocator.appVersionApi.setDataPatchInstallationStatus(query);
