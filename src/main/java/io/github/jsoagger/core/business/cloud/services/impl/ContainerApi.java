...
public class ContainerApi extends AbstractClientApi implements IContainerApi {
  ...
  private static final String GET_CONTAINER_BY_PATH = "/jsoagger/base/v1/secured/api/container/?path=%s";
  private static final String GETCONTAINER = "/jsoagger/base/v1/secured/api/container/%s/";

  private static final String GET_CONTAINER_ADMIN = "/jsoagger/base/v1/secured/api/container/%s/admins";
  private static final String GET_SUBCONTAINER = "/jsoagger/base/v1/secured/api/container/%s/subContainers";
  private static final String ROOT_FOLDER_URI = "/jsoagger/base/v1/secured/api/container/%s/rootFolder";
  private static final String MEMBERS_URI =
      "/jsoagger/base/v1/secured/api/container/%s/members/?page=%s&pageSize=%s&token=%s&includeParentItems=%s";
  private static final String ROLES_URI =
      "/jsoagger/base/v1/secured/api/container/%s/roles/?page=%s&pageSize=%s&includeParentItems=%s";
  private static final String FOLDER_TEMPLATES_URI =
      "/jsoagger/base/v1/secured/api/container/%s/folderTemplates/?page=%s&pageSize=%s&includeParentItems=%s";
  private static final String LIFECYCLE_URI =
      "/jsoagger/base/v1/secured/api/container/%s/lifecycles/?page=%s&pageSize=%s&includeParentItems=%s";
  private static final String ROOT_LINK_TYPES_URI =
      "/jsoagger/base/v1/secured/api/container/%s/rootLinkTypes/?page=%s&pageSize=%s&includeParentItems=%s";
  private static final String ROOT_TYPES_URI =
      "/jsoagger/base/v1/secured/api/container/%s/rootTypes/?page=%s&pageSize=%s&includeParentItems=%s";
  private static final String SUBCONTAINERS_FOLDER_URI =
      "/jsoagger/base/v1/secured/api/container/%s/subContainers/?page=%s&pageSize=%s";
  private static final String rulesIdentifier_URI =
      "/jsoagger/base/v1/secured/api/container/%s/businessRuleIdentifiers/?includeParentItems=%s";
  private static final String enTemplates_URI =
      "/jsoagger/base/v1/secured/api/container/%s/enTemplates/?page=%s&pageSize=%s&includeParentItems=%s";
  private static final String permissions_URI =
      "/jsoagger/base/v1/secured/api/container/%s/permissions/?page=%s&pageSize=%s&";
