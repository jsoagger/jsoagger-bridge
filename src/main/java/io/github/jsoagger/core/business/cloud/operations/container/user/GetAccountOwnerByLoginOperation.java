 ...
 *
 */
public class GetAccountOwnerByLoginOperation implements IOperation {
  ...
  public void doOperation(JsonObject query, Consumer<IOperationResult> resultHandler,
    ...
    try {
      ...
      IOperationResult result = CloudServicesLocator.userPrincipalApi.getAccountOwnerByLogin(query);
